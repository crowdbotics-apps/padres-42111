"""
Django settings for padres_42111 project.
...
ROOT_URLCONF = 'padres_42111.urls'
...
WSGI_APPLICATION = 'padres_42111.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "padres_42111 API",
    "DESCRIPTION": "API documentation for padres_42111 App",
    "VERSION": "v1",
}
